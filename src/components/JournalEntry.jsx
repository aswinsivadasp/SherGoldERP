...
function JournalEntry({ onClose,Open,ledgerJustClosed  }) {
    ...
    try {
      ...
      const hasIncompleteData = tableData.some((row) => {
        return (
          ...
          (!row.debitAccount || !row.creditAccount || !row.amount|| !jvInfoData.Salesman)
        );
      });
    ...
    <div className="regmodal ">
      <div className="schemecontrolls">
        ...
        <div className="schemereg_headerLogo_Div">
          ...
          <label className="schemeReg_pageHead">Journal Entry</label>
        </div>
        <img
          alt="X"
          src={toggleClose}
      ...
      <div className="jventryBody">
        <div className="jventryBodyData">
          <div className="jventryTopdata">
            <div className="jventryTopdatasections jventrysec1">
              <div className="jventryTopdatasectionsrows">
              ...
              <div className="jventryTopdatasectionsrows"></div>
            </div>
            <div className="jventryTopdatasections jventrysec2">
              <div className="jventryTopdatasectionsrows sec2row">
            ...
            <div className="jventryTopdatasections  jventrySec3">
              <div
                className="jventryTopdatasectionsrows sec3row"
                style={{ width: "14vw" }}
              >
                <label>Date</label>
                <input
          ...
          <div
            className="jventryDataTable"
            //  onScroll={handleScroll}
            ref={tableContainerRef}
          >
            <table>
              <thead className="jventryDataTableHead">
                <tr>
                  <th className="jventryDataTableHeadslno">SI No</th>
                  <th className="jventryDataTableHeadDbAcc">
                    Select Debit Account
                  </th>
                  <th className="jventryDataTableHeadCbAcc">
                    Select Credit Account
                  </th>
                  <th className="jventryDataTableHeadamount">Amount</th>
                  <th className="jventryDataTableHeadnarration">Narration</th>
                </tr>
              </thead>
              <tbody className="jventryDataTableBodyStyle">
                {tableData.map((rowData, rowIndex) => (
                  <tr
                    ...
                    className="jventryDataTableBodyStyletr"
                  >
                    <td
                      className="jventryDataTableDataBoxSlno"
                      style={{ textAlign: "center" }}
                    >
                    ...
                    <td
                      className="jventryDataTableDataBoxDbAcc"
                      style={{ width: "22%" }}
                    >
                      {rowIndex % 2 === 0 && (
                        <ComboBox
                          ...
                          options={LedgerName}
                          className="jventryDataTableDataBox test"
                    ...
                    <td
                      className="jventryDataTableDataBoxCdAcc"
                      style={{ width: "22%" }}
                    >
                      {rowIndex % 2 === 0 && (
                        <ComboBox
                    ...
                    <td className="jventryDataTableDataBoxamount">
                      {rowIndex % 2 === 0 && (
                        <input
                          value={
                            tableData[
                          ...
                          className="jventryDataTableDataBox textalignRight"
                    ...
                    <td className="jventryDataTableDataBoxStonenarration">
                      {rowIndex % 2 === 0 && (
                        <input
                          value={
                            tableData[
          ...
          <div className="jventryDataTablefootertotal">
            <input
              className="jventryDataTablefootertotalamount"
            ...
            {/* <input
              className="jventryDataTablefootertotalGm"
